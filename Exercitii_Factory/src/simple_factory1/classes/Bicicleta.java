...
public class Bicicleta implements VehiculLivrare{
    ...
    public Bicicleta(String codVehicul, String zonaOperare, int capacitateKg, int autonomieKm) {
    ...
    public void afiseazaDescriere() {
        ...
        builder.append("Bicicleta are Cod vehicul : ").append(this.codVehicul);
