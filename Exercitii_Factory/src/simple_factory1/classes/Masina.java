...
public class Masina implements VehiculLivrare{
    private String codVehicul;
    private String zonaOperare;
    private int capacitateKg;
    private int autonomieKm;

    public Masina(String codVehicul, String zonaOperare, int capacitateKg, int autonomieKm) {
    ...
    public void afiseazaDescriere() {
        ...
        builder.append("Masina are Cod vehicul : ").append(this.codVehicul);
